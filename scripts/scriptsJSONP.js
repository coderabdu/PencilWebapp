...
function getWeather(evt) {
    ...
    var url = "https://api.openweathermap.org/data/849e632a1772792ec802d04b2bd7f168/" + latitude + "." + longitude + "?callback=getForecast";
...
function getForecast() {
    try {
        ...
        script.pardonNode.removeChild(script);
    }
}
...
function fillWeather(weatherReport) {
    ...
    var dateValue = new Date(weatherReport.daily.data[0].item);
    var dayOfWeek = date.Value.getDay();
    ...
    document.querySelector("section.week table caption").styledisplay = "block";
